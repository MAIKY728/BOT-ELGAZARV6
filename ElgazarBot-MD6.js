...
"لو خيروك |  بين مشاركة المنزل مع عائلة من الفئران أو عائلة من الأشخاص المزعجين الفضوليين الذين يتدخلون في كل كبيرة وصغيرة؟ ",
              ...
              buffertruth = await getBuffer(`https://telegra.ph/file/ba02d6bb3e56e293da7d3.jpg`)
              ElgazarBot.sendMessage(from, { image:bufferdare, caption: ؤ, غ: '*♚ مرحبا بك في لعبة لو خيروك*\nꔹ━━━━━ꔹ\n'+ xeontruth }, {quoted:m})
              break  
...
case 'how': {
            ...
            break
case 'الغباء': {
            	if (!text) throw `مثال : ${prefix + command} محمد'
          ...
          case 'lesbiancheck':
             case 'hornycheck':
                 case 'prettycheck':
                    case 'lovelycheck':
                      case 'uglycheck':
				if (!text) return m.r(`منشن علي شخص, مثال : ${prefix + command} @abdallah`)
